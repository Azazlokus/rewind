...
> Статус: **итерация 24 — мобильное управление** (твин-стик поверх canvas: левый стик —
...
> фронтенд). До этого: командный режим (две команды, баланс при входе, дружественный
