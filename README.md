...
> Статус: **итерация 14 — жизненный цикл матча** (FFA deathmatch с таймером: раунд на
> время, счёт убийств/смертей, детерминированный победитель, антракт и авторестарт;
> табло/таймер/баннер победителя на клиенте). До этого: фундамент бэкенда (аккаунты,
