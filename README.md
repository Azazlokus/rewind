...
> Статус: **итерация 20 — киллстрики + окно неуязвимости** (свежий спавн неуязвим, снаряды
> проходят насквозь; щит спадает от выстрела; серия убийств подряд даёт хил и короткий щит,
> всем уходит reliable `MsgKillstreak`; неуязвимость и серия — в `Checksum`; клиент рисует
> щит-кольцо и баннер). До этого: оружие/пикапы (аптечки, ускорение стрельбы и веер на
