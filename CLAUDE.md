...
## Статус: дорожная карта пройдена; King of the Hill (итер. 29)
...
27 (рывок) + 28 (умный ИИ ботов) + 29 (King of the Hill) сделаны. Из режимов на будущее остаются CTF и
доминация (несколько контрольных точек) — по одному на PR. Дальнейшие работы — по новым запросам; тот же
