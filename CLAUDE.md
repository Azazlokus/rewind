...
## Статус: дорожная карта пройдена; умный ИИ ботов (итер. 28)
...
27 (рывок) + 28 (умный ИИ ботов) сделаны. Дальнейшие работы — по новым запросам; тот же воркфлоу на feature-ветке: ветка →
