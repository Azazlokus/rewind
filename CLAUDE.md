...
## Дальнейший план (итерации 9–11)

Итерации 1–8 из исходного ТЗ и дорожной карты сделаны. Дальше — по запросу «давай все»,
порядок по возрастанию риска (9 → 10 → 11); каждая: исследовать → план → код → /audit →
