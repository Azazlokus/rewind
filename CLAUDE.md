...
## Статус: дорожная карта пройдена; оружие/пикапы (итер. 19)
...
аптечки, ускорение, веер) сделаны. Дальнейшие работы — по новым запросам; тот же воркфлоу на feature-ветке:
