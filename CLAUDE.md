...
## Дальнейший план (итерации 10–11)

Итерации 1–9 из исходного ТЗ и дорожной карты сделаны. Дальше — по запросу «давай все»,
порядок по возрастанию риска (10 → 11); каждая: исследовать → план → код → /audit →
